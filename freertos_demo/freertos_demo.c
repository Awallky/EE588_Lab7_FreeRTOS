...
#define UNLOCKED 0
#define LOCKED 1
extern uint32_t Accelerometer_Init(void);
...
//*****************************************************************************
//
// A few globals from Valvano's MKII demo. // AMW
//
//*****************************************************************************
...
main(void)
{
    ...
    //
    UARTprintf("\n\nWelcome to the EK-TM4C123GXL FreeRTOS/Valvano Booster Pack Demo!\n");
